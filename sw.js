...
const urlsToCache = [
  ...
  '/lizcintado/vendor/react.production.min.js',
  '/lizcintado/vendor/react-dom.production.min.js',
  '/lizcintado/vendor/babel.min.js',
  '/lizcintado/vendor/bcrypt.min.js',
  '/lizcintado/vendor/tailwind-browser.js',
  '/lizcintado/vendor/lucide/lucide.css',
  '/lizcintado/vendor/lucide/lucide.woff2',
  '/lizcintado/utils/push-config.js',
  '/lizcintado/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/lizcintado/icons/icon-192x192.png',
    badge: '/lizcintado/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/lizcintado/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/lizcintado/admin.html';
  event.waitUntil(
